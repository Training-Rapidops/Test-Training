const authorizeUser =
  require("../internal-service-call/auth-service").authorizeUser;
const validateLink =
  require("../internal-service-call/auth-service").validateLink;
const authorizeApplication =
  require("../internal-service-call/auth-service").authorizeApplication;
    ...
    try {
      ...
      if (httpResponse.headers) {
        for (const header in httpResponse.headers) {
          if (
            Object.prototype.hasOwnProperty.call(httpResponse.headers, header)
          ) {
